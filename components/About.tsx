    ...
    <section id='about' className="text-gray-600 body-font">
        <div className="container px-5 py-24 mx-auto flex flex-col">
            ...
            <div className="rounded-lg h-64 overflow-hidden">
                <img alt="content" className="object-cover object-center h-full w-full" src='https://w7.pngwing.com/pngs/956/537/png-transparent-phone-package-woman-girl-telecommunication-entrepreneur-thumbnail.png' />
            </div>
