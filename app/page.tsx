      ...
      <section>
        <div className='container mx-auto flex px-5 py-24 md:flex-row flex-col items-center border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700'>
          <div className='lg:max-w-lg lg:w-full md:w-1/2 w-5/6 mb-10 md:mb-0'>
            <img className='object-cover object-center rounded' alt='hero' src='https://fisiomarket.com/blog-de-fisioterapia/wp-content/uploads/2016/12/magnetoterapia_en_fisioterapia-1.jpg' />
          </div>
